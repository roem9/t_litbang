        ...
        <div class="row">
            <div class="col-lg-6 mt-3">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="m-0 font-weight-bold text-light">Form Data Civitas</h6>
                        </div>
                    </div>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url()?>civitas/insertcivitas" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="tipe">Tipe Civitas <span class="text-danger">*</span></label>
                                <select name="tipe" id="tipe" class="form-control form-control-sm form-1" required>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" name="nip" id="nip" class="form-control form-control-sm form-1" required>
                            </div> -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="no_ktp" id="no_ktp">
                            </div>
                            <div class="d-flex justify-content-end">
                                <input type="submit" value="Simpan Data Civitas" class="btn btn-sm btn-primary float-right" id="simpan">
                            </div>
                        </form>
                    </div>
                </div>
