...
class Kel_model extends CI_Model { 
    ...
    var $column_order = array(null,'status','program',null,'nama_kpq'); //set column field database for datatable orderable
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select("a.id_kelas id_kelas, a.status status, a.program program, CONCAT(a.hari, ' ', a.jam, ' (', a.tempat, ')') jadwal, b.nip nip, b.nama_kpq nama_kpq");
        $this->db->from("kelas_pembinaan as a");
